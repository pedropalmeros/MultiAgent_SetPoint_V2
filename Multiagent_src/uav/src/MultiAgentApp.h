...
class MultiAgentApp : public flair::meta::UavStateMachine {
    ...
    private:
        ...
        ********************************************************************************/
        ...
        std::string *msgStr;
        std::string *PosMessageMixed; //= new std::string("FP,0.000000,0.0000");

        flair::gui::PushButton *btnUpdateFleetPos;

        std::string *BaseX = new std::string();
        std::string *BaseY = new std::string();
        std::string *FPosX = new std::string();
        std::string *FPosY = new std::string();
        std::string *StrX = new std::string();
        std::string *StrY = new std::string();
